...
Garnet implements Qwen3-ASR-0.6B and Qwen3-TTS-12Hz-0.6B-CustomVoice as
...
Load `xModel/qwen3/tts_0_6b_custom_voice/talker_prefill.x` with entry function
...
optional `max_audio_frames`. The result contains GPU `audio`, `sample_rate`
