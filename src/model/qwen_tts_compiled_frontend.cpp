...
namespace Garnet
{
        ...
        X::Value reusableKeyCache, X::Value reusableValueCache)
    {
        ...
        try {
            ...
            inputs.Append(MakeGpuTensor(host, X3_TENSOR_INT64,
